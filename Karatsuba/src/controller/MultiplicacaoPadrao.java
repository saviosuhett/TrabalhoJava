...
public class MultiplicacaoPadrao {
	...
	public static double mult(double a, double b, double n) {
		if (n > 1) {
			...
			double a1b0 = mult(a1, b0, n / 2);
			double a0b1 = mult(a0, b1, n / 2);
			double a0b0 = mult(a0, b0, n / 2);

			return Math.pow(2, n) * a1b1 + Math.pow(2, n / 2) * (a1b0 + a0b1) + a0b0;
		} else {
			return a * b;
		}
	}
